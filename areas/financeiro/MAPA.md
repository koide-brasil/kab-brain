...
- ❌ AR / AP nominal com valor (cliente X deve R$ Y)
- ❌ Negociação financeira em curso com cliente/fornecedor
- ❌ Política comercial real (margem, lock, fórmula indexada)
...
🟡 Esqueleto. Conteúdo seed virá no Sprint 2 com **revisão tripla** dos 3 gatilhos antes de commit. Em dúvida → não entra.
