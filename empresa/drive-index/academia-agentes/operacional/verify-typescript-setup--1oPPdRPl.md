...
area: "kab"
fonte: "google-drive"
drive_id: "1oPPdRPllBPqlCFPQd2KytlIjrYy4qlfv"
...
nome_arquivo: "verify-typescript-setup.js"
...
## Fonte
- Nome: `verify-typescript-setup.js`
- Drive ID: `1oPPdRPllBPqlCFPQd2KytlIjrYy4qlfv`
- Link: https://drive.google.com/file/d/1oPPdRPllBPqlCFPQd2KytlIjrYy4qlfv/view?usp=drivesdk
- Modificado: `2026-04-02`
    ...
    try {
        ...
        if (hasNativePreview && ((_deps_missing = deps.missing) == null ? void 0 : _deps_missing.length) > 0) {
            ...
            if (onlyTypescriptMissing) {
                ...
                log.info(`Detected ${bold('@typescript/native-preview')} as TypeScript compiler. ` + `Some Next.js TypeScript features (like type checking during build) require the standard ${bold('typescript')} package.`);
        ...
        await writeConfigurationDefaults(typescriptVersion, resolvedTsConfigPath, intent.firstTimeSetup, hasAppDir, distDir, hasPagesDir, strictRouteTypes);
