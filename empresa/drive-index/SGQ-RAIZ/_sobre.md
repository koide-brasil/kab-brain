...
# 01-KAB/Drive-Index/SGQ-RAIZ/

⭐ **Pasta SGQ raiz pequena mas com OURO escondido**: 1 única subpasta "**Normas utilizadas - Koide Autopeças**" com **15 normas técnicas ATIVAS** (PDFs originais).

ID raiz: `10how4_t6iz7RocIhF-632GBuaTUISgpn`
...
O Drive da KAB tem **3 pastas SGQ/SGK-relacionadas** na hierarquia compartilhada — fácil de confundir:

| Pasta | ID | Conteúdo | Status |
|---|---|---|---|
| **SGQ** (raiz) | `10how4_t6iz7RocIhF-632GBuaTUISgpn` | Normas técnicas | ⭐ ÚNICA (esta nota) |
| **SGQ-KOIDE** (dentro QUALIDADE/) | (já visto) | Documentos SGK | ✅ JÁ ABSORVIDO via [[../SGK/_sobre]] |
| **DOCUMENTOS Sistema de Gestão Koide** (raiz) | `1QnF9sBQRclIeg7Q2fjj983zBkQmS5Vz6` | DUPLICATA exata do SGK | ✅ Coberto · [[../DOCUMENTOS-SGK-RAIZ/_sobre]] |
...
- [[Pipeline-Cotacoes-BYD-VW-Truck]] (COMPRAS) — BYD pede SUH439/SUS441 que NÃO tem nesta lista
