...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 283
- Processados `kab-brain`: 283
- Processados restritos `my-second-brain`: 177
- Pendentes `kab-brain`: 1834
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 283
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 283
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 283
