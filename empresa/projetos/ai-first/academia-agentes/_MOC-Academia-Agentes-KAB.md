...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 519
- Processados `kab-brain`: 519
- Processados restritos `my-second-brain`: 541
- Pendentes `kab-brain`: 1234
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 519
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 519
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 519
