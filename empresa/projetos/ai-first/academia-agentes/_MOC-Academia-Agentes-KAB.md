...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 581
- Processados `kab-brain`: 581
- Processados restritos `my-second-brain`: 623
- Pendentes `kab-brain`: 1090
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 581
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 581
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 581
