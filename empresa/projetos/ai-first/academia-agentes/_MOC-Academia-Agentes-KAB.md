...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 291
- Processados `kab-brain`: 291
- Processados restritos `my-second-brain`: 193
- Pendentes `kab-brain`: 1810
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 291
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 291
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 291
