...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 796
- Processados `kab-brain`: 796
- Processados restritos `my-second-brain`: 696
- Pendentes `kab-brain`: 802
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 796
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 796
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 796
