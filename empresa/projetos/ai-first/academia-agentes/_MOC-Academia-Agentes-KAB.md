...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 1317
- Processados `kab-brain`: 1317
- Processados restritos `my-second-brain`: 943
- Pendentes `kab-brain`: 34
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 1317
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 1317
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 1317
