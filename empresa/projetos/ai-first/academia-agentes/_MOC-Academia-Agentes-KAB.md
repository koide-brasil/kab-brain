...
## Status da ingestão
- Documentos operacionais consolidados no `kab-brain`: 385
- Processados `kab-brain`: 385
- Processados restritos `my-second-brain`: 219
- Pendentes `kab-brain`: 1690
- Pendentes restritos `my-second-brain`: 770

## Módulos
- [[01-playbooks/Playbook - Agente Intake RFQ KAB.md|Intake RFQ]] — fontes candidatas: 385
- [[01-playbooks/Playbook - Agente Viabilidade RFQ KAB.md|Viabilidade e Produção]] — fontes candidatas: 385
- [[01-playbooks/Playbook - Agente Qualidade KAB.md|Qualidade]] — fontes candidatas: 385
