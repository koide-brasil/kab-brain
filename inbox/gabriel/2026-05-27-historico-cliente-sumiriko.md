...
autor: gabriel
tags: [cliente, historico, faturamento, novos-projetos, risco-comercial]
---

# Histórico do cliente Sumiriko

Cliente: Sumiriko.

Segundo Gabriel, a Sumiriko foi o primeiro cliente da KAB.

Desde então, é o cliente com maior volume de faturamento acumulado para a KAB.

Apesar da relevância histórica e de faturamento, a Koide está há alguns anos sem ser nomeada para novos projetos na Sumiriko.
